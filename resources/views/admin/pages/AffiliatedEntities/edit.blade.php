    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <section class="add_category" id="add_category">
                ...
                {{-- <div class="container"> --}}
                    <h1 class="product_title"> Edit Affiliated Entity </h1>
                    <br>

                    <form method="POST" action="{{ route('affiliated-entities.update',$affiliatedEntity->id) }}" enctype="multipart/form-data">
                         @csrf
                         @method('PUT')
                        ...
                        <div class="form_container ">
                            <div class="form_box">
                                <label for="exampleInputEmail1" class="form_label">Affiliated entity Name</label>
                                <input type="text" class="form_input " name="name"
                                value="{{$affiliatedEntity->name}}">
                                        @error('name')
                                        <div class ="text-danger">{{  $message }}</div>
                                        @enderror
                            </div>
